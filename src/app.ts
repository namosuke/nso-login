...
(async () => {
  ...
  const approvalLink =
    "npf71b963c1b7b6d119://auth#session_state=da0d403b20ed1128cba9c3da46386e049587bccbad582199ca225b8b692e59b9&session_token_code=eyJhbGciOiJIUzI1NiJ9..28MgECjRv1AGKJ7plA872tf978rsLviFmaZVDosPf6g&state=V6DSwHXbqC4rspCn_ArvfkpG1WFSvtNYrhugtfqOHsF6SYyX";
  ...
  const fData = await nsoLogin.getFData(accessToken, 1);
  console.log(fData);
